...
- File JSONL: `reports/exclusion-failure-risk-dataset-2026-07-20T07-42-11-125Z.jsonl`.
- Mỗi dòng là một số bị loại trong một ngày: nhãn `failed`, nhóm nguyên nhân, số family hỗ trợ, active/potential, Tier 1, độ rộng nhỏ nhất và tần suất trung bình.
