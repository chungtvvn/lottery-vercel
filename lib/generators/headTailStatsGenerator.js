            ...
            if (dauSet && dauMap) {
                ...
                stats[dauKey] = {
                    ...
                    veSoleMoi: {
                        ...
                        ...findAlternatingTypeStreaksNew(lotteryData, dateToIndexMap, { condition: dauCondition })
                    }
                };
            }
            ...
            if (ditSet && ditMap) {
                ...
                stats[ditKey] = {
                    ...
                    veSoleMoi: {
                        ...
                        ...findAlternatingTypeStreaksNew(lotteryData, dateToIndexMap, { condition: ditCondition })
                    }
                };
            }
        });
