...
// Chuỗi nhỏ trước là mặc định Đề theo kết quả strict point-in-time hiện tại.
// Đề Song Song vẫn được sinh trong cache để đối chiếu, nhưng không dùng live.
const DEFAULT_BET_STRATEGY = 'chainSmallFirst';
const DEFAULT_BET_TARGET = 70;
const BASELINE_CACHE_VERSION = 'annual20y-baseline-2026-06-28-block-ab';
const MILESTONE20Y_METHOD_VERSION = 'annual20y-2026-07-11-default-chain-small-rff-top6';
const LIVE_CACHE_VERSION = 'annual20y-live-compact-v4';
...
const DEFAULT_PRESETS = [
    { id: 'profit', label: 'Đề Chuỗi nhỏ trước · Hold 70', strategy: DEFAULT_BET_STRATEGY, target: DEFAULT_BET_TARGET },
