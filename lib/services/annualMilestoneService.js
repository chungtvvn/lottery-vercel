...
// Đề Song Song là mặc định Mốc 20 năm. Các số giao nhau giữa Block 85 và
// Chuỗi nhỏ 65 vẫn được lưu trong snapshot để settle đúng tiền x2.
...
const DEFAULT_PRESETS = [
    { id: 'profit', label: 'Đề Song Song Mốc 20 năm · Block 85 + Chuỗi nhỏ 65', strategy: DEFAULT_BET_STRATEGY, target: DEFAULT_BET_TARGET },
