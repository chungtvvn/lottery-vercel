...
async function getExclusions(lotteryData, currentIndex, globalStats, options = {}) {
    ...
    for (const key in quickStats) {
        ...
        // FIX: isSuper PHẢI dựa hoàn toàn trên targetFreqYear, KHÔNG dùng stat.isSuperMaxThreshold
        // vì isSuperMaxThreshold là flag cho computedMaxStreak, không phải cho targetLen hiện tại
