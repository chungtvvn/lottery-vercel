...
function generateAdvisorCache({ history = [], raw = [], existing = [], limit = 90 } = {}) {
    ...
    return {
        ...
        methodology: {
            description: 'Mỗi ngày chọn một trong năm dàn 30 số từ dữ liệu đã kết toán trước ngày dự đoán. Nhật ký lưu snapshot thực tế đã phát hành; nếu cache Advisor bỏ sót nhưng snapshot Lịch sử còn nguyên, bản ghi được tái tạo minh bạch và không tính lại bằng dữ liệu tương lai. Phương pháp Kết hợp giữ 24 số tín hiệu mạnh trong dàn tốt nhất và thay 6 số bằng Z-score nhóm cao.',
