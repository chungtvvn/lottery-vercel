...
function generateAdvisorCache({ history = [], raw = [], existing = [], limit = 90 } = {}) {
    ...
    return {
        ...
        methodology: {
            description: 'Mỗi ngày chọn một trong năm dàn 30 số từ dữ liệu đã kết toán trước ngày dự đoán. Nhật ký chỉ lưu snapshot thực tế đã phát hành; Z-score tạo một dàn hỗ trợ 24+6 để đối soát riêng.',
