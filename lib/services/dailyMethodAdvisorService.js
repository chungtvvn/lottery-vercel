...
function generateAdvisorCache(options = {}) {
    ...
    const streakAwareDeAdvisor = aiResearch.buildStreakAwareDeAdvisor(dualMerge, tripleMerge, adaptiveDualMerge, rawRows);
    const loQuadHybrid = aiResearch.buildLoQuadHybridAdvisor(loQuantumBayesFusion, loDualMerge, raw);
