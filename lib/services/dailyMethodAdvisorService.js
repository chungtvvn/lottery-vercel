...
const CACHE_VERSION = 'daily-advisor-model-selection-v9';
...
function generateAdvisorCache({ history = [], raw = [], existing = [], limit = 90 } = {}) {
    ...
    return {
        ...
        methodology: {
            description: 'Mỗi ngày tự phát hiện toàn bộ phương pháp có trong snapshot. Các dàn 30 số được chấm bằng posterior 7/30/90 ngày, EWMA và cận dưới Wilson; phương pháp khác quy mô được đánh giá bằng profit và hòa vốn riêng. Dàn tổng hợp dùng mọi dàn 30 số, khử dàn trùng, cân bằng theo họ và giảm trọng số dàn gần giống. Nhật ký chỉ giữ snapshot đã phát hành trước kỳ quay.',
