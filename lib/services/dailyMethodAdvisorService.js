...
function generateAdvisorCache({ history = [], raw = [], existing = [], existingDualMerge = null, existingTripleMerge = null, existingAdaptiveDualMerge = null, forceSynthesize = false, limit = 90 } = {}) {
    ...
    const metaLearner = metaLearnerAdvisorService.buildMetaLearnerAdvisor(history || [], rawRows, {
        existingAdvisorCache: { records, dualMerge, adaptiveDualMerge, tripleMerge }
    });
    return {
        version: CACHE_VERSION,
