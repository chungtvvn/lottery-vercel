...
function repairLegacyMalformedParallelSnapshot(snapshot, regeneratedRun) {
    ...
    if (!isLegacyMalformedParallelMethod(originalMethod) || !regeneratedMethod) return snapshot;
    ...
    const summaryUsesMalformedParallel = arraysEqual(
    ...
    const repairedSummary = {
        ...snapshotSummary,
        ...(summaryUsesMalformedParallel ? repairedMethod : {}),
        methods: {
            ...snapshotSummary.methods,
            [PARALLEL_HISTORY_METHOD_ID]: {
                ...repairedMethod,
                snapshotRepairReason: 'legacy-date-less-parallel-fallback'
            }
        }
    };
    ...
    return {
        ...
        parallelSnapshotRepairReason: 'legacy-date-less-parallel-fallback'
    };
}
