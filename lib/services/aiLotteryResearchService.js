...
function buildStreakAwareDeAdvisor(dualMerge, tripleMerge, adaptiveDualMergeOrRaw = null, rawRowsOrOptions = [], maybeOptions = {}) {
    ...
    for (let i = 0; i < totalDays; i++) {
        ...
        const isAbstain = !chosenRow && !isDateLocked;
        let baseSK = isAbstain ? 0 : (chosenRow?.stakeK || (chosenMethod === 'tripleMerge' ? 90000 : 60000));
        let basePK = isAbstain ? 0 : (chosenRow?.payoutK || 0);
