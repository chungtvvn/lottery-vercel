...
function buildStrategicPortfolioGovernor({
    ...
    // 3. TIÊU CHÍ 3: SĂN ĐIỂM RƠI NỔ BÙ ĐỀ ALPHA (REBOUND ALPHA SAU KHI VỪA TRƯỢT)
    // Đề Alpha vừa trượt -> Săn nhịp nổ bù VIP X2 (Tháng 9/2026: 100% các kỳ trượt 1 ngày đều nổ bù VIP X2 ngay hôm sau ăn +108M)
    else if (aType === 'loss') {
        recommendedPortfolioId = 'maxProfit';
        decisionCode = (aLen >= 2) ? 'DIAMOND_REBOUND_ALPHA' : 'GOLDEN_REBOUND_ALPHA';
        badge = (aLen >= 2)
            ? '💎 ĐỀ XUẤT HÔM NAY: GÓI 1 ĐIỂM RƠI KIM CƯƠNG ALPHA (94.3% WIN)'
            : '⚡ ĐỀ XUẤT HÔM NAY: GÓI 1 SĂN ĐIỂM RƠI NỔ BÙ ALPHA (DỒN VIP X2)';
        rationale = (aLen >= 2)
            ? 'Đề Thích Ứng Alpha đã trượt 2 kỳ liên tiếp - Đạt Điểm Rơi Kim Cương với xác suất thắng lịch sử 94.3% (như mốc 19/09 nổ 79 VIP X2 ăn +108M). Kích hoạt Gói 1 dồn toàn lực vào dàn VIP X2 gỡ sạch drawdown!'
            : 'Kỳ trước ngày 25/09 Đề vừa trượt con 65 do bẻ cầu. Theo quy luật dữ liệu tháng 9/2026, 100% các kỳ Alpha trượt 1 ngày (15, 18, 20, 23/09) đều được tiếp nối ngay bằng nhịp NỔ BÙ VIP X2 rực rỡ vào hôm sau (ăn 168M, lãi ròng +108M VIP / ăn 33.6M lãi +21.6M M3). Kích hoạt Gói 1 dồn đòn bẩy VIP X2 và Lô Tam Trụ X3/X2/X1 để ăn trọn sóng nổ bù!';
    }
