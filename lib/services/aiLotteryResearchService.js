...
function buildLoQuadHybridAdvisor(loQuantumBayesFusion, loDualMerge, rawRows = [], loTriHarmonic = null) {
    ...
    const datesList = [];
    const hitMap7 = { quad: {}, qmbf: {}, dual: {}, tri: {} };
    const hitMap20 = { quad: {}, qmbf: {}, dual: {}, tri: {} };
    ...
    if (s7Quad.streakType === 'win' && s7Quad.streakLen >= 1 && s7Quad.streakLen < 3) {
        selectedEngine = 'quad';
    ...
    if (selectedEngine === 'qmbf' && qmbfRankedNext.length > 0) activeRanked = qmbfRankedNext;
