...
function parseHoldMethodFromId(methodId) {
    const match = String(methodId || '').match(/^(riskHold|frequencyHold|tierHold|edgeHold|bayesHold|scarcityHold|recordHold|recordFirstHold|potentialHold|wilsonHold)(\d{1,3})$/);
    if (!match) return null;
