 ...
 * 4. Chuỗi tiềm năng cũng đi theo điểm ưu tiên; tần suất hình thành là tín hiệu trong điểm, không phải filter cứng
...
function calculateExclusionPriority(dropOffInfo, reliability = {}) {
    ...
    const potentialNeedsFrequencyGuard = !!dropOffInfo.isPotential && !!dropOffInfo.usesFrequencyFallback;
    const scarcity = potentialNeedsFrequencyGuard
