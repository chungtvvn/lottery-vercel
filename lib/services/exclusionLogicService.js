...
function getDropOffExclusions(quickStats, options = {}) {
    ...
    // Chỉ bỏ qua patterns Lớn/Nhỏ (quá rộng, ~50 số, không có giá trị dự đoán)
    // Giữ nguyên tất cả patterns khác (3d, chan/le, etc.) - đúng với Tổng Hợp Dự Đoán
    ...
    for (const key in quickStats) {
        ...
        // Bỏ qua patterns quá rộng (chỉ Lớn/Nhỏ)
        if (excludedPatterns.includes(category)) continue;
        ...
        // Không giới hạn số lượng - đúng với Tổng Hợp Dự Đoán trên Statistics page
