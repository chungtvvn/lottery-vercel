...
/**
 * Normalizes and merges runs from history and advisor snapshots.
 */
function normalizeDualMergeRuns(historyRecords, existingAdvisorRecords) {
...
function buildDualMergeAdvisor(historyRecords, rawRows, options = {}) {
    ...
    // Normalize runs from history + advisor snapshots
    const orderedRuns = normalizeDualMergeRuns(historyRecords, options.existingAdvisorRecords);
