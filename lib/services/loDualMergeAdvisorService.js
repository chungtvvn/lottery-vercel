...
function buildDynamicCrossMethodAdvisor(loAdvisorsMap = {}) {
    ...
    const nextPrediction = {
        ...
        goldenXien2: (() => {
            const top4 = (tomorrowStd?.numbers || []).slice(0, 4);
            const p1 = top4.length >= 2 ? [top4[0], top4[1]] : ['36', '12'];
            const p2 = top4.length >= 3 ? [top4[0], top4[2]] : ['36', '49'];
            const p3 = top4.length >= 4 ? [top4[1], top4[2]] : ['12', '49'];
            return [
                {
                    pair: p1,
                    numbers: p1,
        ...
        xien3: (() => {
            const top3 = (tomorrowStd?.numbers || []).slice(0, 3);
            const nums = top3.length === 3 ? top3 : ['36', '12', '49'];
            return {
