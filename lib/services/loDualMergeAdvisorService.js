...
function buildDynamicCrossMethodAdvisor(loAdvisorsMap = {}, rawRows = []) {
...
function buildMetaCrossMethodStrategy(loAdvisorsMap = {}, rawRows = []) {
    const dynamicAdvisor = buildDynamicCrossMethodAdvisor(loAdvisorsMap, rawRows);
