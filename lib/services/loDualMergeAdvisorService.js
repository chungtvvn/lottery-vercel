...
function buildSmartRecommendation(pendingRankedNumbers, rankDist, summary, xien4Summary) {
    ...
    const recommendedXien4 = {
        clusterId: bestXien.clusterId || 'x1',
        label: (bestXien.clusterId === 'x2' ? 'Xiên X2 (Rank 5-8)' : 'Xiên X1 (Rank 1-4)'),
        numbers: (bestXien.clusterId === 'x2' ? ranked20.slice(4, 8) : ranked20.slice(0, 4)),
        ...
        h3: bestXien.h3 || 0,
        h2: bestXien.h2 || 0,
        rationale: `Cụm ${(bestXien.clusterId === 'x2' ? 'Xiên X2 (Rank 5-8)' : 'Xiên X1 (Rank 1-4)')} đạt tỷ lệ ngày có lãi ${(bestXien.winRate * 100).toFixed(1)}%, nổ ${(bestXien.h4)} lần 4/4 (ăn 384M), ${(bestXien.h3)} lần 3/4 (ăn 84M) và ${(bestXien.h2)} lần 2/4 (ăn 12M), mang lại ROI kỷ lục +${(bestXien.roi * 100).toFixed(1)}%.`
    };
