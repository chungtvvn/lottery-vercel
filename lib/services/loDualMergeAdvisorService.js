...
function buildMetaCrossMethodStrategy(loAdvisorsMap = {}) {
    ...
    if (bestXien4Candidate) {
        ...
        xien4Rec.recommendedClusterInfo = {
            ...
            numbers: xien4Rec[bestXien4Candidate.clusterId]?.numbers || [],
            stakeK: 11000,
            liveProfitK: bestXien4Candidate.liveProfitK,
            liveRoi: bestXien4Candidate.liveRoi,
            rationale: `Tuyển chọn từ ${bestXien4Candidate.stratLabel} - Xiên ${bestXien4Candidate.clusterId.toUpperCase()} với Lợi Nhuận Live cao nhất (+${((bestXien4Candidate.liveProfitK || 0)/1000).toFixed(1)}M, ROI +${(((bestXien4Candidate.liveRoi || 0)*100)).toFixed(1)}%).`
        };
    }
