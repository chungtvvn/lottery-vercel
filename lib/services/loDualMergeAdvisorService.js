...
function buildDynamicCrossMethodAdvisor(loAdvisorsMap = {}, rawRows = [], options = {}) {
    ...
    nextPrediction = {
        ...
        subTiers: {
            2: {
                size: 2,
                label: 'Song Thủ Siêu VIP (Cược X2)',
                methodId: 'loTriConsensusFusion',
                methodName: 'Tam Trụ Tri-Consensus Fusion',
            ...
            6: {
                size: 6,
                label: 'Lục Thủ Tinh Tuyển',
                methodId: 'loQuantumBayesFusion',
                methodName: 'Siêu Hợp Nhất QMBF 7D',
                numbers: (strategies.loQuantumBayesFusion?.latestRec?.top6 || consensusRanked.slice(0, 6)),
                stakeK: 13200,
            ...
            8: {
                size: 8,
                label: 'Bát Thủ Đột Phá',
                methodId: 'loPentaMatrix',
                methodName: 'Ngũ Hợp Penta-Matrix v8.0',
                numbers: (strategies.loPentaMatrix?.latestRec?.top8 || consensusRanked.slice(0, 8)),
                stakeK: 17600,
