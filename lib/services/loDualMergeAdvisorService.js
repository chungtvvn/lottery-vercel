...
function buildDynamicCrossMethodAdvisor(loAdvisorsMap = {}, rawRows = [], options = {}) {
    ...
    // Combo 1: QMBF(Top 7) + QUAD(Top 7) [Lợi Nhuận Tối Đa +3.001 TỶ - Win 98.5%]
    const c1Votes = {};
    ...
    const optimalCrossTierEnsemble = {
        primary: {
            id: 'qmbf7_quad7',
            name: '🔥 Ghép Đôi QMBF(Top 7) + QUAD(Top 7)',
            badge: '👑 Kỷ Lục +3.001 TỶ · Nổ 98.5% Ngày',
            description: 'Tổ hợp ghép tầng tối ưu profit cao nhất toàn hệ thống năm 2026. Số trùng đánh X2 (đòn bẩy), số riêng đánh X1 (bảo hiểm), chuỗi trượt tối đa chỉ 3 ngày.',
            overlapX2: c1X2,
            singlesX1: c1X1,
            distinctNumbers: c1Distinct,
            totalNumbers: c1Distinct.length,
            stakeK: c1X2.length * 4400 + c1X1.length * 2200,
            historicalStats: {
                winRate: '73.9%',
                hitRate: '98.5%',
                profitM: '+3001.2M',
