...
function getCategoryName(category, subcategory, originalKey = null) {
    ...
    if (subcategory) {
        ...
        if (subcategory === 'block2x1SoLe') return `${catName} - Nhịp 2-1 (AABAA)`;
        if (subcategory === 'block2x2SoLe') return `${catName} - Nhịp 2-2 (AABBAA)`;
        if (subcategory === 'block3x2SoLe') return `${catName} - Nhịp 3-2 (AAABBAAA)`;
        if (subcategory === 'block3x3SoLe') return `${catName} - Nhịp 3-3 (AAABBBAAA)`;
        if (subcategory === 'block4x2SoLe') return `${catName} - Nhịp 4-2 (AAAABBAAAA)`;
        if (subcategory === 'block4x3SoLe') return `${catName} - Nhịp 4-3 (AAAABBBAAAA)`;
